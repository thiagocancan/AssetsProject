<div>
    <div class="bg-orange-600/90 flex font-medium items-center mb-6">
        ...
        <p class="text-amber-50 text-3xl m-12 font-light">Get the best files for creations, 3D printing, content and more.</p>
    </div>
                ...
                <div class="p-4 bg-white dark:bg-gray-800 flex flex-col gap-2 h-50">
                    ...
                    <div class="flex items-center justify-between text-zinc-500 font-normal text-sm">
                        <div class="flex items-center gap-2">
                            <img class="size-7 rounded-full" src="https://ui-avatars.com/api/?name={{ urlencode($asset->user->name) }}&background=random" alt="">
